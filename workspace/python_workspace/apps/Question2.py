...
print("Matches in 2014 : " + str(worldcup_matches.filter(worldcup_matches.Year.like("2014")).count()))

# 5 Count the no.of times Argetina has appeared in semi-finals
worldcup_matches.filter(
    worldcup_matches.Round.like("Semi-finals") & (worldcup_matches.Home_Team == 'Argentina')).count()
